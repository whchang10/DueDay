...
# Background 
Most of the existing calendar applications are made for personal use. It is difficult to arrange a meeting for a group and see available time slots of others. Our team developed a calendar application which designed to serve the need of a group. Group members are having a hard time to set up group meetings since they do not know the schedule of other people in their group. With our application, members can import his or her schedule with privacy and sees the available time slots of others. Having this kind of application that keeps track of everyone’s schedule, users can save a plenty of time from setting up a meeting and start their works smoothly. Also, project managers can manage the time frames and assign tasks to their group members efficiently.
# Features
